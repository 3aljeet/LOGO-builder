...
test('Circle render method generates correct SVG', () => {
  ...
  const expectedSVG = `
      <svg width="300" height="200" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="150" y="100" text-anchor="middle" dominant-baseline="middle" fill="white">
          Your Text
        </text>
      </svg>
    `;
...
test('Triangle render method generates correct SVG', () => {
  ...
  // Set text value and textColor
  triangle.text = "Your Text"
